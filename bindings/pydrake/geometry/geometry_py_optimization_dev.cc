...
//            doc.CIrisCollisionGeometry.geometry.doc)
...
//  }
//  {
//    // Definitions for c_iris_separating_plane.h/cc
...
////            .def_readwrite("prog", &SeparationCertificateProgramBase::prog)
//            .def_readwrite(
//                "plane_index",
...
//              // containing the geometry ids and the certificate for that
//              pair. std::vector<std::tuple<geometry::GeometryId,
//              geometry::GeometryId,
//                  CspaceFreePolytope::SeparationCertificateResult>>
//                  certificates_ret;
//              certificates_ret.reserve(certificates.size());
//              for (const auto& [key, value] : certificates) {
//                certificates_ret.emplace_back(key.first(), key.second(),
//                value);
//              }
...
//            py::arg("s_center"), py::arg("options"),
//            cls_doc.BinarySearch.doc);
//    {
//      using BaseClass
//      =geometry::optimization::SeparationCertificateResultBase;
//      py::class_<Class::SeparationCertificateResult,
//                 SeparationCertificateResultBase>(
//          cspace_free_polytope_cls, "SeparationCertificateResult",
...
//          .def_readonly("plane_decision_var_vals",
//                        &BaseClass::plane_decision_var_vals,
//                        py_rvp::copy);
//    }
...
//        .def_readwrite(
//            "solver_id",
//            &Class::FindPolytopeGivenLagrangianOptions::solver_id)
//        .def_readwrite("solver_options",
...
//        &Class::BilinearAlternationOptions::max_iter)
...
//  //      doc.GetCollisionGeometries.doc);
//}
