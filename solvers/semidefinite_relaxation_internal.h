...
// is equivalent to each column of X being in the Lorentz cone.
...
// Adds the constraint that the matrix X is a conic combination of Lorentz
// separable tensors. Namely X = ∑ᵢ λᵢxᵢyᵢᵀ where λᵢ ≥ 0, xᵢ is in the Lorentz
// cone of size X.rows() and y is in the Lorentz cone of size X.cols()
