...
//    std::cout << fmt::format("Test mat size = ({},{})", test_mat.rows(), test_mat.cols()) << std::endl;
//    std::cout << fmt::format("Y size = ({},{})", Y.rows(), Y.cols()) << std::endl;
...
//  unused(k);
//  unused(l);
//  // These all need to be Lorentz Positive Maps. We achieve this by making them
