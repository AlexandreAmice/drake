...
//  std::map<Variables, bool> variables_to_enforce_sparsity{
//      {Variables{y(0)}, true},
//      {Variables{y(0), y(2)}, false},
//      {Variables{y(1), y(2)}, true}};
//
//  auto relaxation =
//      MakeSemidefiniteRelaxation(prog, variables_to_enforce_sparsity);
//  const Variable one{relaxation->decision_variables().tail<1>()(0)};
//
//  EXPECT_EQ(relaxation->num_vars(), 10);
//  EXPECT_EQ(relaxation->positive_semidefinite_constraints().size(), 3);
//  // The minors corresponding to the outer product of the variables
//  // (y(0),1), (y(0), y(2)), (y(1),y(2),1) should be psd.
//  EXPECT_EQ(
//      Variables(
//          relaxation->positive_semidefinite_constraints().at(0).variables()),
//      GetMinorVariablesFromMakeSemidefiniteRelaxationVars(
...
//          relaxation->positive_semidefinite_constraints().at(1).variables()),
//      GetMinorVariablesFromMakeSemidefiniteRelaxationVars(
//          relaxation->decision_variables(), prog.num_vars(), {0, 3}));
//  EXPECT_EQ(
//      Variables(
//          relaxation->positive_semidefinite_constraints().at(2).variables()),
//      GetMinorVariablesFromMakeSemidefiniteRelaxationVars(
